...
To assess whether or not more satisfied workers mean more hours spent with families and wheter or not it fills their needs. To see if there is an interaction with working time and quality of life. 

The data is from Add Health.
...
How much does work interefere with family time and are working people feeling satisfied with the amount of family time they currently have?
...
8.  **Infections Can Lower IQ** A headline in June 2015 proclaims “Infections can lower IQ.” The headline is based on a study in which scientists gave an IQ test to Danish men at age 19. They also analyzed the hospital records of the men and found that 35% of them had been in a hospital with an infection such as an STI or a urinary tract infection. The average IQ score was lower for the men who had an infection than for the men who hadn’t.  
    ...
    + What are the cases in this study?
      + The people that are the suject of the study. (19 y/o Danish men)
    ...
    + What is the response variable? Is it categorical or quantitative?
      + Is there an infection? Categorical.
    ...
    + Is it appropriate to conclude causation in this case?
      + No, not at all. As it is an observation studies the relationship between the infection and IQ score but does not allow for the assumption of causation. 
    + Is it appropriate to generalize these results to all Danish men age 19?
      + If it were a random sample, it would be. However, as there is no information provided as to how the sample was chosen, we should not generalize the results. 
